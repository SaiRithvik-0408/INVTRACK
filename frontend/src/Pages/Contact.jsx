...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formDataToSend.append("subject", "Thank You for Your Feedback!");
    formDataToSend.append("message", `Hi ${formData.name},\n\nThank you for reaching out to us. We appreciate your feedback and will get back to you shortly.\n\nBest regards,\nYour Company Team`);
    ...
    if (data.success) {
      setResult("Form Submitted Successfully! Thank you for your feedback.");
